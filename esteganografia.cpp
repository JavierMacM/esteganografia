...
int main(int argc,char** argv) {
	...
	char temp;
	char msg_temp;
	unsigned char MaskTable[] = { 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80 };
...
// Revisar el modo de ejecucion del sistema, a para agregar texto, o para obtener texto
	if(!strcmp(argv[1],"-a")){
		modo=1;
	}else if(!strcmp(argv[1],"-o")) {
		modo=0;
	}
//abrimos el archivo de la imagen en modo lectura
...
//abrimos el 4 argumento, texto a guardar en la imagen (-a abrir regresara true )
	...
	//En caso de estar en modo -o obtener mensaje se ejecuta lo siguiente
	else {
...
//Obtenemos el tamaño del mensjae en la imagen
